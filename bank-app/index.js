...
class Customer {
    ...
    mobNumber;
    accNumber;
    constructor(fNmae, lName, age, gender, mob, acc) {
    ...
    do {
        ...
        if (service.select == "View Balance") {
            ...
            if (account) {
                ...
                console.log(`${chalk.green.bold(name?.firstName)} ${chalk.green.bold(name?.lastName)} Your Account Balance is ${chalk.bold.blueBright(`$${account.balance}`)}`);
            }
        }
        //Cash Withdraw
